...
#include "uv_msgs/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const uv_msgs::msg::Detection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uv_msgs::msg::Detection & ros_message)
{
  // Member: class_id
  cdr >> ros_message.class_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = uv_msgs::msg::Detection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const uv_msgs::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uv_msgs::msg::Detection *>(
    untyped_ros_message);
...
{
  return &uv_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uv_msgs, msg, Detection)() {
  return &uv_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
