...
#include "uv_msgs/msg/detail/waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const uv_msgs::msg::Waypoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uv_msgs::msg::Waypoint & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = uv_msgs::msg::Waypoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const uv_msgs::msg::Waypoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uv_msgs::msg::Waypoint *>(
    untyped_ros_message);
...
{
  return &uv_msgs::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uv_msgs, msg, Waypoint)() {
  return &uv_msgs::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
