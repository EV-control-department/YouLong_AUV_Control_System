...
#include "uv_msgs/msg/detail/detection_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const uv_msgs::msg::DetectionArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uv_msgs::msg::DetectionArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        uv_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Detection(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = uv_msgs::msg::DetectionArray;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        uv_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Detection(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const uv_msgs::msg::DetectionArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uv_msgs::msg::DetectionArray *>(
    untyped_ros_message);
...
{
  return &uv_msgs::msg::typesupport_fastrtps_cpp::_DetectionArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uv_msgs, msg, DetectionArray)() {
  return &uv_msgs::msg::typesupport_fastrtps_cpp::_DetectionArray__handle;
}
