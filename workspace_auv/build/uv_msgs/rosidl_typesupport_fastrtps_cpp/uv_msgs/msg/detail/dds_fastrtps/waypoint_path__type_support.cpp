...
#include "uv_msgs/msg/detail/waypoint_path__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const uv_msgs::msg::Waypoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  uv_msgs::msg::Waypoint &);
size_t get_serialized_size(
  const uv_msgs::msg::Waypoint &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const uv_msgs::msg::WaypointPath & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uv_msgs::msg::WaypointPath & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        uv_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Waypoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = uv_msgs::msg::WaypointPath;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_uv_msgs
max_serialized_size_key_WaypointPath(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        uv_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Waypoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const uv_msgs::msg::WaypointPath *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uv_msgs::msg::WaypointPath *>(
    untyped_ros_message);
...
{
  return &uv_msgs::msg::typesupport_fastrtps_cpp::_WaypointPath__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uv_msgs, msg, WaypointPath)() {
  return &uv_msgs::msg::typesupport_fastrtps_cpp::_WaypointPath__handle;
}
