...
{
  new (message_memory) uv_msgs::msg::MotionCommand(_init);
}

void MotionCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<uv_msgs::msg::MotionCommand *>(message_memory);
  typed_message->~MotionCommand();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember MotionCommand_message_member_array[6] = {
  {
    "mode",  // name
    ...
    offsetof(uv_msgs::msg::MotionCommand, mode),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uv_msgs::msg::MotionCommand, type_mask),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uv_msgs::msg::MotionCommand, x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uv_msgs::msg::MotionCommand, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uv_msgs::msg::MotionCommand, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uv_msgs::msg::MotionCommand, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotionCommand_message_members = {
  ...
  6,  // number of fields
  sizeof(uv_msgs::msg::MotionCommand),
...
get_message_type_support_handle<uv_msgs::msg::MotionCommand>()
{
  return &::uv_msgs::msg::rosidl_typesupport_introspection_cpp::MotionCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uv_msgs, msg, MotionCommand)() {
  return &::uv_msgs::msg::rosidl_typesupport_introspection_cpp::MotionCommand_message_type_support_handle;
}
