...
bool uv_msgs__msg__device_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uv_msgs.msg._device_command.DeviceCommand", full_classname_dest, 41) == 0);
  }
  uv_msgs__msg__DeviceCommand * ros_message = _ros_message;
  {  // device_type
...
{
  /* NOTE(esteve): Call constructor of DeviceCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("uv_msgs.msg._device_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DeviceCommand");
