...
class Metaclass_DetectionArray(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from uv_msgs.msg import Detection
...
class DetectionArray(metaclass=Metaclass_DetectionArray):
    ...
    _fields_and_field_types = {
        ...
        'camera_name': 'string',
        'detections': 'sequence<uv_msgs/Detection>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['uv_msgs', 'msg'], 'Detection')),  # noqa: E501
    )
