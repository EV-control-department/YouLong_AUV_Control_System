...
bool uv_msgs__msg__motion_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uv_msgs.msg._motion_command.MotionCommand", full_classname_dest, 41) == 0);
  }
  uv_msgs__msg__MotionCommand * ros_message = _ros_message;
  {  // mode
...
PyObject * uv_msgs__msg__motion_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("uv_msgs.msg._motion_command");
