...
class ObjectPosition(metaclass=Metaclass_ObjectPosition):
    ...
    def __init__(self, **kwargs):
        ...
        self.num_observations = kwargs.get('num_observations', int())
    ...
    def __eq__(self, other):
        ...
        if self.confidence != other.confidence:
            return False
        if self.num_observations != other.num_observations:
            return False
        return True
    ...
    def num_observations(self):
        """Message field 'num_observations'."""
    ...
    def num_observations(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'num_observations' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'num_observations' field must be an unsigned integer in [0, 4294967295]"
