...
class Metaclass_GetState_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from uv_msgs.msg import AuvState
            if AuvState.__class__._TYPE_SUPPORT is None:
                AuvState.__class__.__import_type_support__()
...
class GetState_Response(metaclass=Metaclass_GetState_Response):
    ...
    _fields_and_field_types = {
        'state': 'uv_msgs/AuvState',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['uv_msgs', 'msg'], 'AuvState'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        if self._check_fields:
            assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
                ...
                ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        from uv_msgs.msg import AuvState
        self.state = kwargs.get('state', AuvState())
    ...
    def state(self, value):
        if self._check_fields:
            from uv_msgs.msg import AuvState
            assert \
                isinstance(value, AuvState), \
                "The 'state' field must be a sub message of type 'AuvState'"
        self._state = value
...
class GetState_Event(metaclass=Metaclass_GetState_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<uv_msgs/GetState_Request, 1>',
        'response': 'sequence<uv_msgs/GetState_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['uv_msgs', 'srv'], 'GetState_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['uv_msgs', 'srv'], 'GetState_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from uv_msgs.srv import GetState_Request
    ...
    def response(self, value):
        if self._check_fields:
            from uv_msgs.srv import GetState_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_GetState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from uv_msgs.srv import _get_state
...
class GetState(metaclass=Metaclass_GetState):
    from uv_msgs.srv._get_state import GetState_Request as Request
    from uv_msgs.srv._get_state import GetState_Response as Response
    from uv_msgs.srv._get_state import GetState_Event as Event
