...
#include "zit6_interfaces/srv/detail/update_params__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const zit6_interfaces::srv::UpdateParams_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  zit6_interfaces::srv::UpdateParams_Request & ros_message)
{
  // Member: json
  cdr >> ros_message.json;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zit6_interfaces::srv::UpdateParams_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const zit6_interfaces::srv::UpdateParams_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<zit6_interfaces::srv::UpdateParams_Request *>(
    untyped_ros_message);
...
{
  return &zit6_interfaces::srv::typesupport_fastrtps_cpp::_UpdateParams_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zit6_interfaces, srv, UpdateParams_Request)() {
  return &zit6_interfaces::srv::typesupport_fastrtps_cpp::_UpdateParams_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zit6_interfaces
cdr_serialize(
  const zit6_interfaces::srv::UpdateParams_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  zit6_interfaces::srv::UpdateParams_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = zit6_interfaces::srv::UpdateParams_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const zit6_interfaces::srv::UpdateParams_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<zit6_interfaces::srv::UpdateParams_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &zit6_interfaces::srv::typesupport_fastrtps_cpp::_UpdateParams_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zit6_interfaces, srv, UpdateParams_Response)() {
  return &zit6_interfaces::srv::typesupport_fastrtps_cpp::_UpdateParams_Response__handle;
}
...
// functions for zit6_interfaces::srv::UpdateParams_Request already declared above

// functions for zit6_interfaces::srv::UpdateParams_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zit6_interfaces
cdr_serialize(
  const zit6_interfaces::srv::UpdateParams_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  zit6_interfaces::srv::UpdateParams_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zit6_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_UpdateParams_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zit6_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_UpdateParams_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = zit6_interfaces::srv::UpdateParams_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zit6_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_UpdateParams_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zit6_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_UpdateParams_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const zit6_interfaces::srv::UpdateParams_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<zit6_interfaces::srv::UpdateParams_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &zit6_interfaces::srv::typesupport_fastrtps_cpp::_UpdateParams_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zit6_interfaces, srv, UpdateParams_Event)() {
  return &zit6_interfaces::srv::typesupport_fastrtps_cpp::_UpdateParams_Event__handle;
}
...
static const rosidl_service_type_support_t _UpdateParams__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<zit6_interfaces::srv::UpdateParams_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<zit6_interfaces::srv::UpdateParams_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<zit6_interfaces::srv::UpdateParams_Event>(),
...
{
  return &zit6_interfaces::srv::typesupport_fastrtps_cpp::_UpdateParams__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zit6_interfaces, srv, UpdateParams)() {
  return &zit6_interfaces::srv::typesupport_fastrtps_cpp::_UpdateParams__handle;
}
