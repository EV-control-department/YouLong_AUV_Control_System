...
class UpdateParams_Event(metaclass=Metaclass_UpdateParams_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<zit6_interfaces/UpdateParams_Request, 1>',
        'response': 'sequence<zit6_interfaces/UpdateParams_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['zit6_interfaces', 'srv'], 'UpdateParams_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['zit6_interfaces', 'srv'], 'UpdateParams_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from zit6_interfaces.srv import UpdateParams_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from zit6_interfaces.srv import UpdateParams_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_UpdateParams(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'zit6_interfaces.srv.UpdateParams')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from zit6_interfaces.srv import _update_params
...
class UpdateParams(metaclass=Metaclass_UpdateParams):
    from zit6_interfaces.srv._update_params import UpdateParams_Request as Request
    from zit6_interfaces.srv._update_params import UpdateParams_Response as Response
    from zit6_interfaces.srv._update_params import UpdateParams_Event as Event
